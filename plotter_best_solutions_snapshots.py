        ...
        for version in versions:
            ...
            for solver in solvers:
                for decoder_type in decoder_types:
                    num_snapshots = 0
                    while True:
                        filename = "best_solutions_snapshots/" + instance + "_" + solver + "_" + str(decoder_type) + "_" + version + "_" + str(num_snapshots) +  ".txt"
            ...
            for snapshot in range(num_snapshots):
                ...
                for i in range(len(solvers)):
                    for j in range(len(decoder_types)):
                        filename = "best_solutions_snapshots/" + instance + "_" + solvers[i] + "_" + str(decoder_types[j]) + "_" + version + "_" + str(snapshot) +  ".txt"
